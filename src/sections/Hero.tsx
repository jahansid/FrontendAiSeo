  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute size-[344px] md:size-[580px] rounded-full border border-white opacity-20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
      >
      ...
      <motion.div
        ...
        className=" absolute size-[444px] md:size-[780px] rounded-full border border-white/20 border-dashed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
      ></motion.div>
      {/* ring3 */}
      <motion.div
        style={{
